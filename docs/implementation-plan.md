...
| 06 | [Data Protection & Redis Key Persistence](issues/06-data-protection-redis.md) | ⬜ | Needs 05 first |
| 10 | [Two-Factor Authentication (TOTP)](issues/10-two-factor-authentication.md) | ⬜ | Needs 04 first |
...
| # | Issue | Status | Notes |
|---|-------|--------|-------|
| 11 | [Client Test Application](issues/11-client-test-application.md) | ⬜ | Needs 01, 02, 03, 07 |
